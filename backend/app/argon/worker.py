...
from app.argon.config import argon_settings as settings
...
from app.argon.utils.progress import ProgressTracker  # noqa: E402
...
async def ingest_file_task(ctx: dict, source_id: str):
    ...
    """
    from app.argon.db_compat import async_session_factory
    from app.argon.db_compat_models import Source, SourceImage
    from app.argon.services.image_service import extract_images
    from app.argon.services.kb_service import (
        _extract_text_from_file,
        _inline_image_markers,
    )
    from app.argon.services.source_outline import assemble_full_text, build_outline
    from app.argon.services.storage_service import storage_service
    ...
    async with async_session_factory() as session:
        ...
        try:
            ...
            async def _mark_error_file() -> None:
                from app.argon.db_compat import async_session_factory as _sf
                from app.argon.db_compat_models import Source as _Source
...
async def ingest_url_task(ctx: dict, source_id: str):
    ...
    from app.argon.db_compat import async_session_factory
    from app.argon.db_compat_models import Source
    from app.argon.services.kb_service import _extract_text_from_url
    from app.argon.services.source_outline import assemble_full_text, build_outline
...
async def ingest_skill_task(ctx: dict, skill_id: str, version_id: str, file_path: str, file_name: str):
    ...
    from app.argon.db_compat import async_session_factory
    from app.argon.db_compat_models import Skill, SkillVersion
    from app.argon.services.storage_service import storage_service
    ...
    async with async_session_factory() as session:
        ...
        try:
            ...
            from app.argon.services.kb_service import _guess_content_type
...
async def delete_skill_task(ctx: dict, skill_id: str):
    ...
    """
    from app.argon.db_compat import async_session_factory
    from app.argon.db_compat_models import Skill
    from app.argon.services.storage_service import storage_service
...
async def reembed_all_pages_task(ctx: dict, job_id: str) -> None:
    ...
    from app.argon.ai.embedding_catalog import get_spec
    from app.argon.ai.registry import ProviderRegistry
    from app.argon.db_compat import async_session_factory
    from app.argon.db_compat_models import EmbeddingJob, WikiPage
    from app.argon.services.config_service import (
        ACTIVE_EMBEDDING_MODEL_KEY,
        ConfigService,
    )
    from app.argon.services.embedding_storage import (
...
async def ingest_map_reduce_task(ctx: dict, source_id: str):
    ...
    """
    from app.argon.ai.mrp.pipeline import run_mrp_pipeline
    from app.argon.ai.registry import ProviderRegistry
    from app.argon.db_compat import async_session_factory
    from app.argon.db_compat_models import KnowledgeType, Source
...
async def ingest_refine_task(ctx: dict, source_id: str):
    ...
    """
    from app.argon.ai.mrp.pipeline import run_refine_pipeline
    from app.argon.ai.registry import ProviderRegistry
    from app.argon.db_compat import async_session_factory
    from app.argon.db_compat_models import KnowledgeType, Source
...
async def regenerate_plan_task(ctx: dict, source_id: str, user_note: str):
    ...
    """
    from app.argon.ai.mrp.reducer import reconcile_with_kb, run_planning_call
    from app.argon.ai.registry import ProviderRegistry
    from app.argon.db_compat import async_session_factory
    from app.argon.db_compat_models import Source, SourceCompilationPlan
...
async def sweep_stuck_ai_review_cron(ctx: dict):
    ...
    from app.argon.db_compat import async_session_factory
    from app.argon.db_compat_models import WikiPageDraft
...
async def daily_stats_rollup_cron(ctx: dict):
    ...
    from app.argon.services.stats_aggregator import run_daily_rollup
...
async def ai_pre_review_draft_task(
    ...
    """
    from app.argon.services.ai_review import run_async_checks
    _ = ctx
