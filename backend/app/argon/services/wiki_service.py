...
from app.argon.db_compat_models import WikiLink, WikiPage, WikiPageDraft, WikiPageRevision
...
async def search_pages_semantic(
    ...
    from app.argon.db_compat_models import get_embedding_model_for_dim
