"""
Argon MCP Resources — static/semi-static data exposed to Claude.
...
def register_resources(mcp: FastMCP):
    ...
    @mcp.resource("argon://about")
    async def about_argon() -> str:
        """About this Argon instance — capabilities and instructions."""
        return (
            "# Argon Knowledge Base\n\n"
            "You are connected to an Argon enterprise LLM Wiki. Knowledge is organized "
    ...
    async def wiki_index_resource() -> str:
        ...
        from app.argon.mcp.tools import _get_identity
