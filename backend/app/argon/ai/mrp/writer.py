...
from app.argon.ai.providers.base import EmbeddingProvider, LLMProvider
...
async def _write_page_complex(
    ...
    Returns (content_md, summary, citations_meta).
    """
    from app.argon.ai.agent_protocol import assistant_message_from_turn, tool_results_message
    ...
    for step in range(WRITER_AGENT_MAX_STEPS):
        from app.argon.ai.agent_protocol import AssistantTurn
        try:
