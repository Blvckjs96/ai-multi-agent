...
from app.argon.db_compat import get_db
from app.argon.db_compat_models import Employee, ScopeType, Source, SourceDepartment, WikiPage
from app.argon.db_compat_repository import Repository
from app.argon.services.audit_service import log_audit
from app.argon.services.auth_compat import (
    get_current_user,
    require_permission,
)
...
async def get_arq_pool() -> ArqRedis:
    ...
    if _arq_pool is None:
        from app.argon.worker import _get_redis_settings
...
async def get_source(
    ...
    from app.argon.services.permission_engine import can_access_document
...
async def update_source(
    ...
    if body.department_ids is not None:
        ...
        if old_dept_ids != new_dept_ids and source.status == "ready":
            ...
            from app.argon.ai.mrp.pipeline import _resolve_wiki_scopes
