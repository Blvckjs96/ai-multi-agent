...
from app.argon.services.auth_compat import require_permission
...
async def get_llm_catalog(
    ...
    from app.argon.ai.llm_catalog import list_specs
...
async def switch_llm_model(
    ...
    from app.argon.ai.llm_catalog import UnknownLLMModel, get_spec
...
async def get_vision_catalog(
    ...
    from app.argon.ai.registry import ProviderRegistry
    from app.argon.ai.vision_catalog import list_specs
    from app.argon.services.config_service import ConfigService
...
async def switch_vision_model(
    ...
    from app.argon.ai.vision_catalog import UnknownVisionModel, get_spec
    from app.argon.services.config_service import ACTIVE_VISION_MODEL_KEY, ConfigService
