...
|----------|---------|-------------|
| `PROJECT_NAME` | `ai_multi_agent` | Display name for the project |
...
| `POSTGRES_DB` | `ai_multi_agent` | Database name |
...
| `LOGFIRE_SERVICE_NAME` | `ai_multi_agent` | Service name in Logfire dashboard |
